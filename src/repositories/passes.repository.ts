...
class PassesRepository {
    async getAll(queryParams: {
        ...
        const sortCol = validSort.includes(queryParams.sort as string)
            ? `p.${queryParams.sort}`
            : "p.id";
